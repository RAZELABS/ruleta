<div class="menu-bar">
    <div class="container h-100">
        ...
        <a href=@isset($codigo_tienda)"https://www.ruletafalabella.com/?t={{$codigo_tienda}}" @else "{{route('home')}}" @endisset class="btn btn-menu-fb float-end mt-2" style="z-index: 100; display: block; position: relative;">
