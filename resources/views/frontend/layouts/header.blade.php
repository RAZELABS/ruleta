                ...
                <div class="header-column">
                    <div class="header-row">
                        <div class="header-logo">
                            <a href="#">
                                <img src="{{asset('img/logos/logo_fa.png')}}" class="img-fluid" style="height: 40px !important" alt=""/>
                            </a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="header-nav-main header-nav-main-text-capitalize header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-effect-2 header-nav-main-sub-effect-1">
                                <nav class="collapse">
                                    <ul class="nav nav-pills" id="mainNav">
                                        <li><a href="#" class="nav-link active" data-hash data-hash-offset="0" data-hash-offset-lg="70">Enlace 1</a></li>
                                        <li><a href="#" class="nav-link active" data-hash data-hash-offset="0" data-hash-offset-lg="70">Enlace 2</a></li>
                                        <li><a href="#" class="nav-link active" data-hash data-hash-offset="0" data-hash-offset-lg="70">Enlace 3</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div> --}}
