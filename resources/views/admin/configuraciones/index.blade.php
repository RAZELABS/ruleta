    ...
    <div class="row mt-3">
        <div class="col-12 px-3">
            <div class="row bg-configuracion b-radius-20 px-2 mt-3 mt-md-0">
                <div class="col-12 px-4 pt-2 text-center font-weight-bolder text-secondary">matriz
                </div>
                <div class="col-3">
                    <div class="featured-boxes  m-0  ">
                        <div class="featured-box my-2 b-radius-20 ">
                            <a href="{{ url('p_carbon') }}" class="text-decoration-none">
                                <span class="p-1 text-center d-block">
                                    <span class="text-secondary display-5"><i class="fa-solid fa-mound"></i></span>
                                    <span class="font-weight-bold    d-block text-secondary ">Carbon</span>
                                </span>
                            </a>
                        </div>
                    </div>
